        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tight text-neutral-800"
            >
              <span className="block text-neutral-800">{t.projects.hero.title.prefix}</span>
