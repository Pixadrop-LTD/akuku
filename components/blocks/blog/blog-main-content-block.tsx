...
export const BlogMainContentBlock = () => {
  const { t } = useLocale()
    ...
    <section className="relative px-4 pb-16 sm:pb-20 lg:pb-24">
      <div className="mx-auto max-container-2xl px-6 lg:px-8">
        <motion.div
          ...
          className="mx-auto max-container rounded-2xl border border-neutral-200/70 bg-secondary-50/60 px-6 py-12 backdrop-blur-sm sm:px-10 sm:py-16"
        >
