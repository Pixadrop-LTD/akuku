...
type ContentTermsBlockProps = {
  children: ReactNode
  className?: string
}

const ContentTermsBlock = ({ children, className }: ContentTermsBlockProps) => {
  const ref = useRef<HTMLDivElement>(null)
  const isInView = useInView(ref, { once: true, amount: 0.15 })

  return (
    <section className="relative px-2 lg:px-4 pt-28 pb-16 sm:pt-32 sm:pb-20 lg:pb-24">
      <div className="mx-auto max-container-2xl px-2 lg:px-8">
        <motion.div
          ...
          className="mx-auto max-container lg:px-10 px-4 py-5 lg:py-10 bg-secondary-50 rounded-2xl"
        >
          <div
            className={cn(
...
export default ContentTermsBlock
