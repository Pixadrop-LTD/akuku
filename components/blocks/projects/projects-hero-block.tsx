      ...
      >
        ...
        >
          <motion.span
            ...
            className="inline-flex items-center gap-2 rounded-full border border-nuetral/20 bg-white/10 px-4 py-2 text-sm tracking-widest text-neutral-900 uppercase shadow-sm backdrop-blur-sm"
          >
